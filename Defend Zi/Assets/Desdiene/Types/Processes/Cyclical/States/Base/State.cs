...
namespace Desdiene.Types.Processes.Cyclical.States
{
    public abstract class State : IStateEntryExitPoint
    {
        ...
        {
            add => _stateContext.OnStopped = SubscribeToOnStopped(_stateContext.OnStopped, value);
            remove => _stateContext.OnStopped -= value;
        }
        ...
        protected abstract Action SubscribeToOnStopped(Action onCompleted, Action value);
