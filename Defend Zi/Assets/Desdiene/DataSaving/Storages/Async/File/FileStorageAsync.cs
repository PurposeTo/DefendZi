...
{
    public abstract class FileStorageAsync<T> : StorageAsync<T> where T : IValidData
    {
        protected FileStorageAsync(string storageName, string baseFileName, string fileExtension)
            : base(storageName)
        {
